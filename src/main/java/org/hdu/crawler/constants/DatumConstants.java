...
public class DatumConstants {	
	...
	public static final String GOOGLE_HK_SEARCH_URL = "https://www.google.com.hk/search?ei=gAjxWqPPFeqfgAafpauABg&safe=strict&sa=N&biw=1920&bih=189&filter=0&q=%s&start=%d"; //&num=50
	public static final String GOOGLE_SEARCH_URL = "https://www.google.com/search?ei=9ILuWoH8G-HP5gKPrb6IBA&filter=0&num=50&q=%s&start=%d";
	public static final String BAIDU_SEARCH_URL = "https://www.baidu.com/s?ie=utf-8&cl=0&rn=50&wd=%s&pn=%d"; //cl:是否限制条数
	...
	public static final String GOOGLE_COOKIES = "SIDCC=%s; 1P_JAR=%s";
	public static final String GOOGLE_HK_COOKIES = "NID=%s; 1P_JAR=%s; DV=Q80d9Ge6PGEWUE1YFEyngrOiF-QxNhY";
	
	public static final int DEFAULT_DEPTH = 50;
	public static final int DEFAULT_COUNT = 50000;
}
