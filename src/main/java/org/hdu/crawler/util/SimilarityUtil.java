...
public class SimilarityUtil {
    ...
    public static void main(String[] args) {
        String data = "地震活动和动作都是以实现预定目的为特征的，但是动作受单一目的的制约。而活动则受一种完整的目的和动机系统的制约。活动是由一系列动作构成的系统。\n" +
                ...
                "人的心理、意识是在活动中形成和发展起来的。通过活动，人认识周围世界，形成人的各种个性品质；反过来，活动本身又受人的心理、意识的调节。这种调节具有不同的水平。肌肉的强度、运动的节律是在感觉和知觉水平上进行的调节，而解决思维课题的活动则是在概念水平上进行的调节。\n" +
                "活动可以分为外部活动和内部活动。从发生的观点来看，外部活动是原初的,内部活动起源于外部活动,是外部活动内化的结果。内部活动又通过外部活动而外化。这两种活动具有共同的结构，可以相互过渡。\n" +
                "人的活动的基本形式有3种:游戏、学习和劳动。这3种形式的活动在人们不同发展阶段起着不同的作用,其中有一种起着主导作用。例如在学龄前，儿童的主导活动是游戏；到了学龄期，游戏活动便逐步为学习活动所取代；到了成人期，劳动便成为人的主导活动。活动是由共同目的联合起来并完成一定社会职能的动作的总和。活动由目的、动机和动作构成，具有完整的结构系统。苏联心理学家从20年代起就对活动进行了一系列研究。其中Α.Н.列昂节夫的活动理论对苏联心理学的发展影响很大，成为现代苏联心";
        Map<String, Object> keywordInfo1 = new HashMap();
        keywordInfo1.put("keyword", "地震");
        keywordInfo1.put("weight", "2");
        keywordInfo1.put("idf", "6.22156152");
        Map<String, Object> keywordInfo2 = new HashMap();
        keywordInfo2.put("keyword", "预测");
        keywordInfo2.put("weight", "8");
